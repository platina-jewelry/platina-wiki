...
отделов. **Platina Wiki** станет вашим надежным помощником для решения повседневных рабочих задач.
...
- **Бухгалтерия**:
    - Хранение налоговых инструкций, отчетов, памяток по работе с документами.

- **Отдел кадров**:
    - Публикация инструкций для сотрудников, шаблонов документов, графиков отпусков.

- **Производство**:
    - Хранение инструкций по работе с оборудованием, стандартов качества, технологических процессов.

- **Отдел продаж**:
    - Сценарии продаж, базы знаний по продуктам, обучающие материалы.

- **Маркетинг**:
    - Руководства по продвижению, стратегии, шаблоны для рекламных материалов.

- **Охрана**:
    - Инструкции по безопасности, планы эвакуации, регламенты работы.

- **Транспорт служебный и гараж**:
    - Графики обслуживания, регламенты использования служебного транспорта, документы по технике безопасности.
...
- **Отдел 1С**:
    - Руководства по работе с 1С, инструкции по настройке и обновлению конфигураций, документация по интеграциям.

## Основные возможности платформы

### 1. Структурированный доступ к информации

- После авторизации пользователь видит список разделов, который ему доступен (например: **Бухгалтерия**, **Отдел кадров
  **, **Производство**, **Отдел продаж**, **Отдел разработки**, **Отдел 1С**).
- Разделы содержат статьи, отсортированные по дате добавления, с функцией поиска.

### 2. Создание и редактирование статей

- **Каждый пользователь** может:
    - Создавать статьи с помощью удобного редактора.
    - Добавлять изображения и файлы.
- Все статьи сразу становятся доступными для чтения другим сотрудникам.

### 3. Поиск по всей платформе

- Полнотекстовый поиск по названию, содержимому статьи и категории.
